...
**bogleheads** — Debating active stock-picking vs low-cost passive indexing; want the 3-fund, cost-minimization, set-and-forget approach.
Example: "I've been losing to the S&P 500 picking my own stocks for 5 years. Is a simple 3-fund index portfolio actually a better life strategy?"
...
**dollar-cost-averaging** — Sitting on cash that needs deploying, or torn between lump-sum and spreading entries over time.
